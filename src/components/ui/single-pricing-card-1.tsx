		...
		<section className='relative min-h-screen overflow-hidden py-24'>
			<div id='pricing' className='mx-auto w-full max-w-6xl space-y-5 px-4'>
				...
				>
					...
					<h2 className='mt-5 text-center font-bold text-2xl tracking-tighter md:text-3xl lg:text-4xl'>
							...
							<div className='w-full px-4 pt-5 pb-4'>
								...
								<div className='mt-10 space-y-4'>
									<div className='flex items-end gap-0.5 text-muted-foreground text-xl'>
										<span>$</span>
										<span className='-mb-0.5 font-extrabold text-4xl text-foreground tracking-tighter md:text-5xl'>
											7.99
										</span>
										<span>/month</span>
									</div>
									<Button className='w-full' variant='outline' asChild>
										...
										{/** biome-ignore lint/a11y/useValidAnchor: <Not Implemented yet> */}
